# Contributing to Leadership Artifacts
...
2. Include: Artifact number, current link, proposed link, why it's better
3. Tag with `research-improvement`

### 3. Suggest New Artifacts

Think we're missing an important organizational artifact?

**How to suggest:**
1. Open an issue with the artifact name and description
2. Explain: What it is, who uses it, why it's important
3. Provide 1-2 examples if possible
4. Tag with `new-artifact`

### 4. Report Issues

Found a broken link, typo, or technical problem?

**How to report:**
1. Open a regular issue
...
- Include personally identifiable information without consent

### For Research Links

**Good sources include:**
- .edu - Universities and academic institutions
- .gov - Government agencies
- Professional organizations (PMI, SHRM, OECD, etc.)
- Standards bodies (ISO, NIST, etc.)
- Peer-reviewed journals
- Well-documented real-world implementations

**Avoid:**
- Marketing content or sales pages
- Paywalled content (unless truly authoritative)
...
4. **Approval** - If approved, we'll add it to the catalog
5. **Credit** - You'll be credited in the example (unless anonymous)

**Review criteria:**
- Accuracy and quality
- Appropriate anonymization
- Adds value to existing examples
