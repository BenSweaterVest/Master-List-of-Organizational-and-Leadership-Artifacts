        ...
        <div class="main-layout">
            ...
            <main>
                <div class="content methodology">
                    <h2>Conceptual Hierarchy and Relationships</h2>
                    <p>Foundational artifacts exist in a logical hierarchy that effective leaders must understand:</p>

                    <div class="framework-box">
                        <strong>The Strategic Foundation (Identity Layer):</strong><br>
                    ...
                    <div class="framework-box">
                        <strong>Key Distinction: Guiding Principles vs. Core Values</strong><br>
                        <ul style="margin-top: 0.5rem; list-style: none; padding-left: 0;">
                            <li>• <strong>Core Values</strong> are fundamental beliefs that define organizational culture (rarely change)</li>
                            <li>• <strong>Guiding Principles</strong> are strategic decision-making frameworks (adaptive to changing conditions)</li>
                            <li>• Example: "Honesty" is a value; "Prioritize customer satisfaction in every decision" is a principle</li>
                        </ul>
                    </div>
                    ...
                    <div class="framework-box">
                        <strong>The Five-Layer Framework (Recommended):</strong><br>
                        <span style="font-size: 1.1rem; display: block; margin: 0.75rem 0;">
                    ...
                    <div class="framework-box">
                        <strong>Six Foundational Documents:</strong>
                        ...
                        <p style="margin-top: 1rem; font-style: italic; opacity: 0.95;">
                            <strong>Key Insight:</strong> The distinction between Values (cultural beliefs) and Guiding Principles (decision-making frameworks),
                            as well as between Strategic Goals (long-term objectives) and Priorities (current focus), provides critical clarity for both
                            strategy formulation and day-to-day operations. This 5-layer framework with 6 foundational documents makes implicit decisions explicit.
                        </p>
                    </div>
                </div>
